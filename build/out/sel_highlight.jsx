...
export const Tooltip = ({ hoverState }) => {
  ...
  if (top + tooltipH > 354) top = y - tooltipH - 15;
...
export default function Widget({ model, React }) {
  ...
  return (
    <div style={{ width, height: 400, background: '#f2f0e9', display: 'flex', flexDirection: 'column', margin: 0, padding: 0, boxSizing: 'border-box', overflow: 'hidden' }}>
      <div style={{ width, height: chartH, position: 'relative', flexShrink: 0 }}>
        <svg
          ref={svgRef}
          width={width}
          height={chartH}
      ...
      <div style={{ padding: '0 15px 4px 15px', width: '100%', boxSizing: 'border-box', flex: 1, display: 'flex', alignItems: 'flex-start', overflow: 'hidden' }}>
        <select
          value={selectedGroup}
